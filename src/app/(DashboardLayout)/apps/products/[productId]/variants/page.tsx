...
export default async function ProductVariantsPage(
  ...
  return (
    <PageContainer title="Gestionar variantes" description="Grupos de opciones y variantes del producto">
      <Breadcrumb title="Gestionar variantes" subtitle="Configuracion avanzada de variantes" items={[{ to: "/apps/products", title: "Productos" }, { to: `/apps/products/${productId}`, title: "Producto" }, { title: "Variantes" }]} />
      <BlankCard>
