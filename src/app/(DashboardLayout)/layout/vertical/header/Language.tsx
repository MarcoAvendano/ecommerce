...
const Language = () => {
  ...
  const currentLanguage = useCustomizerStore((state) => state.isLanguage);
  const setLanguage = useCustomizerStore((state) => state.setLanguage);
  const currentLang =
    Languages.find((_lang) => _lang.value === currentLanguage) || Languages[1];
