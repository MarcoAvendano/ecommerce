...
const Customizer: FC = () => {
  ...
  const setTheme = useCustomizerStore((state) => state.setTheme);
  const setDir = useCustomizerStore((state) => state.setDir);
  const setDarkMode = useCustomizerStore((state) => state.setDarkMode);
  const toggleLayout = useCustomizerStore((state) => state.toggleLayout);
  const toggleSidebar = useCustomizerStore((state) => state.toggleSidebar);
  const toggleHorizontal = useCustomizerStore((state) => state.toggleHorizontal);
  const setBorderRadius = useCustomizerStore((state) => state.setBorderRadius);
  const setCardShadow = useCustomizerStore((state) => state.setCardShadow);
            ...
            <Grid container spacing={2}>
              {thColors.map((thcolor) => (
                <Grid item xs={4} key={thcolor.id}>
                  <StyledBox onClick={() => setTheme(thcolor.disp || "BLUE_THEME")}>
